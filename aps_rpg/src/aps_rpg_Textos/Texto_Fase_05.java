...
public class Texto_Fase_05 extends Personagem_Principal {
		...
		public String txt10 = "Gostaríamos de expressar nossa sincera gratidão por participar do nosso RPG Textual dedicado à limpeza do Rio Tietê.\n"
				+ " Sua dedicação e interesse em aprender sobre questões ambientais são verdadeiramente inspiradores.\n";
		
		public String txt11 = "Embora nosso RPG tenha chegado ao fim, esperamos que as lições aprendidas e a consciência despertada continuem a ecoar em sua vida diária.\n"
				+ "Juntos, podemos trabalhar para um futuro onde o Rio Tietê, e todos os nossos recursos naturais, sejam limpos, seguros e sustentáveis para as gerações futuras.\n";
